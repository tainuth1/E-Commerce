...
<div class="w-full h-full px-4 pb-6">
    <div class="flex justify-between items-center my-4">
        ...
        <div class="flex items-center gap-7 text-gray-600">
            ...
            <div class="relative">
                <form action="" class="">
                    <input type="text" placeholder="Search . . . . " class="w-[300px] outline-[1px] focus:outline-blue-600 text-gray- focus:shadow-lg shadow-inner px-4 py-2 rounded-lg border-[1px] border-gray-300 dark:bg-gray-200">
